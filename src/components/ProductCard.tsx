...
import { Sparkles, Image as ImageIcon, Check, Eye, Package, ShieldCheck } from 'lucide-react';
      ...
      <div className="flex-1 flex flex-col px-3 pb-2 z-10">
        ...
        <div className="space-y-2 mt-auto">
          <button
            ...
            className="w-full py-2 text-[11px] text-zinc-400 hover:text-white transition-colors flex items-center justify-center gap-1 border border-zinc-800/80 hover:border-zinc-700 rounded-lg cursor-pointer"
          >
            <Package className="w-3.5 h-3.5 text-zinc-400" />
            <span>ดูอุปกรณ์ในเซ็ต & ข้อมูลสเปก</span>
          </button>
